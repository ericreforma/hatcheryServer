...
export default class EventCreate extends Component {
    constructor(props) {
        ...
        this.state = {
            pages: ['Content', 'Photos' ,'Jobs', 'Scheduling', 'Publish'],
            currentPage: 0,
            completedPage: [],
            skillList: [],
            jobList: [],
        ...
        if(this.state.isPublishing) {
            ...
            switch(this.state.currentPage) {
                ...
                case 1:
                    return <Photos {...attr}/>
                case 2:
                    return <Jobs  {...attr} skillList={this.state.skillList} jobList={this.state.jobList}/>
                case 3:
                    return <Scheduling {...attr} />
                case 4:
    ...
    publish = () => {
        ...
        formData.append('jobs',JSON.stringify(this.state.jobs));
        formData.append('scheduling',JSON.stringify(this.state.scheduling));
