...
export default class Content extends Component{
    ...
    componentDidMount() {
        this.setState({
            ...
            image: this.props.parentState.content.image || null,
            imagePreview: this.props.parentState.content.imagePreview || null,
    ...
    schedule = () => 
        this.state.schedule.map((date, index) =>
            <div className='date_item' key={index}>
                ...
                <div className='break_value date_column'>
                    <Input type='select' value={date.breaktime} 
                        onChange={e => {
                            this.changeBreakTime(date, e.target.value)
                        }}
                    >
                            {this.breaktimeOptions().map(o => o) }
                        </Input>
                </div>
                
                <div className='work_value date_column'>
                ...
                <div className='options_value date_column'>
                    <UncontrolledButtonDropdown size="sm" color='primary' className='option_select'>
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownItem onClick={() => {
                                this.setBreakTimeAsDefault(date)
                            }}>Set Breaktime As Default</DropdownItem>
                        </DropdownMenu>
                            ...
                            {/* PHOTO */}
                                <FormGroup>
                                    ...
                                    <Input 
                                        ...
                                        invalid={this.props.checkError('image')}
                                    />
                        ...
                        <div className='requirement_container campaign_create_container'>
                            ...
                            <div className='schedule_list_container'>
                                <div className='schedule_list_header'>
                                    ...
                                    <div className="date_head breaktime_head">Break (mins)</div>
                                    <div className="date_head work_head">Work Hours</div>
                            ...
                            <Row>
                                <Col md='6'>
                                    <FormGroup>
                                        ...
                                        <Input value={this.state.days_total} type="text" disabled/>
                                    </FormGroup>
                                ...
                                <Col md='6'>
                                    <FormGroup>
                                        ...
                                        <Input value={this.state.hours_total} type="text" disabled/>
                                    </FormGroup>
                                </Col>
                            </Row>
                            <hr />
